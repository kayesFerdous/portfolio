...
const ChatbotMarkdown = dynamic(() => import("@/components/chatbot-markdown").then((m) => m.ChatbotMarkdown), {
  ssr: false,
})
...
// Markdown rendering is split into a separate chunk (loaded only when needed)
                  ...
                  >
                    ...
                    >
                      {message.role === "assistant" ? (
                        <ChatbotMarkdown content={message.content} isSystem={message.id === "welcome"} />
                      ) : (
                ...
                {currentStreamingMessage && (
                  ...
                  >
                    <div className="max-w-[90%] bg-zinc-50 dark:bg-zinc-900/60 border-l-2 border-gray-200 dark:border-zinc-700 rounded-xl px-4 py-3">
                      <ChatbotMarkdown content={currentStreamingMessage} />
